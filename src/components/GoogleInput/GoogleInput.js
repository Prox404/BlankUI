function GoogleInput({className='',disabled = false, Label='', id='',...props}) {
    return (<div className="relative z-0 w-full mb-6 group">
        <input id={id} className={`${className} block py-2.5 px-3 w-full text-sm text-gray-900 bg-transparent border-[1px] rounded-md border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer ${disabled && 'cursor-not-allowed'}`} {...props} placeholder=" " disabled={disabled}/>
