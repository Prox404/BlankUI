...
function UploadFile({
    ...
    return (<>
        <div className="flex flex-col">
            ...
            <label htmlFor="upload" className="p-5 border border-dashed border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:bg-slate-50" >
                {
                    !file && <FiUpload className="w-10 h-10 mx-auto text-gray-400 dark:text-gray-500" />
                }
                {
                    file && <div className="flex flex-col mt-2">
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white">{file.name}</p>
                    </div>
                }
            </label>
