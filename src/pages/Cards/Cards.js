        ...
        <div>
            <div >
                ...
                <main>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="button-card">
                            <span className="text-gray-400"> # </span>
                            Card With Button
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="link-card">
                            <span className="text-gray-400"> # </span>
                            Card With Link
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="image-card">
                            <span className="text-gray-400"> # </span>
                            Card With Image
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="horizontal-card">
                            <span className="text-gray-400"> # </span>
                            Horizontal Card
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="profile-card">
                            <span className="text-gray-400"> # </span>
                            Profile Card
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="form-card">
                            <span className="text-gray-400"> # </span>
                            Form Card
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="e-commerce-card">
                            <span className="text-gray-400"> # </span>
                            E-commerce Card
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="nav-card">
                            <span className="text-gray-400"> # </span>
                            ...
                            `}>Facts</button>
                                ...
                                <div id="defaultTabContent">
                                    <div className={`${tabs === 'about' ? 'block' : 'hidden'} p-4 bg-white rounded-lg md:p-8 `} id="about" role="tabpanel" aria-labelledby="about-tab">
                                        <p className="mb-3 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Powering innovation & trust at 200,000+ companies worldwide</p>
                                    ...
                                    <div className={` ${tabs === 'services' ? 'block' : 'hidden'} p-4 bg-white rounded-lg md:p-8 " id="services" role="tabpanel" aria-labelledby="services-tab`}>
                                        <p className="mb-5 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">We invest in the world’s potential</p>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100" >
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="list-card">
                            <span className="text-gray-400"> # </span>
                            Card With List
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100">
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="pricing-card">
                            <span className="text-gray-400"> # </span>
                            Pricing card
                        </h2>
                        <div>
                    ...
                    <section className="mb-4 pb-4 border-b-2 border-slate-100">
                        <h2 className="font-medium leading-tight text-2xl mt-0 mb-2" id="crypto-card">
                            <span className="text-gray-400"> # </span>
                            Crypto Card
                        </h2>
                        <div>
