            ...
            <div className="bg-[var(--colorBGPrimary)] border-gray-200 px-4 lg:px-6 py-2.5 ">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="/" className="flex items-center">
                        <BsCircleHalf className="mr-3 h-6 sm:h-9 text-2xl text-[var(--colorTextPrimary)]"/>
                        <span className="self-center text-[var(--colorTextPrimary)] text-xl font-semibold whitespace-nowrap dark:text-white">BlankUI</span>
                    </a>
                    ...
                    <div className={`${isMobileMenuOpen ? 'md:flex' : 'md:hidden'} justify-between items-center md:w-full flex w-auto order-1`} id="mobile-menu-2">
                        <ul className="flex flex-row md:flex-col md:mt-4 font-medium mt-0">
                            <li>
                                <a href="/" className="block py-2 pr-4 pl-3 text-[var(--colorTextPrimary)] rounded bg-primary-700 md:bg-transparent md:text-primary-700 md:p-0 dark:text-white" aria-current="page">Home</a>
                            </li>
                            <li>
                                <a href="/" className="block py-2 pr-4 pl-3 text-[var(--colorTextPrimary)] md:border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Company</a>
                            </li>
                            <li>
