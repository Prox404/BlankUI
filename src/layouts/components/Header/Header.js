            ...
            <nav className="bg-[var(--colorBGPrimary)] border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center order-2 md:order-1">
                        ...
                        <button data-collapse-toggle="mobile-menu-2" type="button" className=" items-center p-2 ml-1 text-sm text-gray-500 rounded-lg hidden md:inline-flex hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
                    ...
                    <div className="md:hidden justify-between items-center md:w-full flex w-auto order-1" id="mobile-menu-2">
